            ...
            <div class="dashboard_container">
                <div class="control_menu">
                    ...
                    <div class="dash_menu_items">
                        ...
                        <div class="dash_list">
                            <ul>
                                <a href=""><li><i class="fa fa-users"> </i> Producten</li></a>
                                <a href=""><li><i class="fa fa-sign-out"></i> Categorieen</li></a>
                                <a href=""><li><i class="fa fa-sign-out"></i> Users</li></a>
                                <a href=""><li><i class="fa fa-sign-out"></i> Uitloggen</li></a>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="control_screen">
                        <div class="product_all">
                            <div class="product_in_control">
                                <img src="https://picsum.photos/40" width="200px" alt="">
                            ...
                            <div class="edit_form invisible">
                                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="Post" class="">
                                    ...
                                    <button name="edit" class="edit_btn" placeholder="edit"  value="Log in">Wijzigen</button>
                                </form>
                            </div>
                        </div>
                        <div class="product_all">
                            <div class="product_in_control">
                                <img src="https://picsum.photos/50" width="200px" alt="">
                                <div class="edit_remove_product">
                                    <p>WIJZIGEN <i class="editpro_btn far fa-edit"></i> </p>
                                    <p>VERWIJDEREN <i class="delete_btn far fa-trash-alt"></i></p>
                                </div>
